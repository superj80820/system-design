...
require (
	...
	github.com/testcontainers/testcontainers-go/modules/kafka v0.26.0 // indirect
	github.com/testcontainers/testcontainers-go/modules/mongodb v0.26.0 // indirect
