...
// SendAddFriendStatusMessage provides a mock function with given fields: ctx, userID, friendID
func (_m *ChatRepository) SendAddFriendStatusMessage(ctx context.Context, userID int, friendID int) error {
	ret := _m.Called(ctx, userID, friendID)

	if len(ret) == 0 {
		panic("no return value specified for SendAddFriendStatusMessage")
	}
...
// SendJoinChannelStatusMessage provides a mock function with given fields: ctx, userID, channelID
func (_m *ChatRepository) SendJoinChannelStatusMessage(ctx context.Context, userID int, channelID int) error {
	ret := _m.Called(ctx, userID, channelID)

	if len(ret) == 0 {
		panic("no return value specified for SendJoinChannelStatusMessage")
	}
...
// SendUserOnlineStatusMessage provides a mock function with given fields: ctx, userID, onlineStatus
func (_m *ChatRepository) SendUserOnlineStatusMessage(ctx context.Context, userID int, onlineStatus domain.StatusType) error {
	ret := _m.Called(ctx, userID, onlineStatus)

	if len(ret) == 0 {
		panic("no return value specified for SendUserOnlineStatusMessage")
	}
...
// SubscribeFriendMessage provides a mock function with given fields: ctx, userID, notify
func (_m *ChatRepository) SubscribeFriendMessage(ctx context.Context, userID int, notify func(*domain.FriendMessage) error) {
...
// UnSubscribeFriendMessage provides a mock function with given fields: ctx, userID
func (_m *ChatRepository) UnSubscribeFriendMessage(ctx context.Context, userID int) {
